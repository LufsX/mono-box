<script lang="ts">
  ...
  import { formatConnectionDuration as formatDuration, highlightJson, sortConnections, type EnrichedConnection, type SortMode } from "$lib/page-state/connections";
  ...
  function applySort() {
    sortConnections(connections, sortMode, defaultOrderIndex);
  }
